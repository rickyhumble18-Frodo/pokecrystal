...
WillGroup:
	...
	db 92, XATU,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 92, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 93, SLOWKING,   CURSE, AMNESIA, SURF, PSYCHIC_M
	db 94, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 95, ESPEON,     PSYBEAM, MORNING_SUN, BATON_PASS, PSYCHIC_M
	db 96, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 96,  HITMONTOP,  PURSUIT, QUICK_ATTACK, DIG, DETECT
	db 96,  HITMONLEE,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 97,  HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 98,  STEELIX,    IRON_TAIL, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 99,  HERACROSS,  MEGAHORN, ROCK_SLIDE, EARTHQUAKE, REVERSAL
	db 100, MACHAMP,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	db 98,  MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 98,  VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 99,  UMBREON,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 100, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 101, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db 102, TYRANITAR,  ROCK_SLIDE, EARTHQUAKE, CRUNCH, FIRE_BLAST
	db -1 ; end
...
KogaGroup:
	...
	db 94, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 94, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 95, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 96, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 97, WEEZING,    SLUDGE_BOMB, EXPLOSION, TOXIC, HAZE
	db 98, CROBAT,     DOUBLE_TEAM, QUICK_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	db 100, GYARADOS,   FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	db 100, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 101, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 102, KINGDRA,    SURF, ICE_BEAM, DRAGONBREATH, HYPER_BEAM
	db 103, DRAGONITE,  THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	db 106, DRAGONITE,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
ScientistGroup:
	...
	db 48, PORYGON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db 48, PORYGON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db 48, PORYGON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db 48, PORYGON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 16, CHARMANDER, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 16, SQUIRTLE,   WITHDRAW, WATER_GUN, BITE, CURSE
	db 16, BULBASAUR,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 50, KINGLER,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
	db 50, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	db 48, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	db 48, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	db 49, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	db 49, ELECTABUZZ, THUNDERPUNCH, LIGHT_SCREEN, SWIFT, SCREECH
	db -1 ; end

	; COOLTRAINERM (9)
	db "JAKE@", TRAINERTYPE_MOVES
	db 51, PARASECT,   LEECH_LIFE, SPORE, SLASH, SWORDS_DANCE
	db 51, PARASECT,   LEECH_LIFE, SPORE, SLASH, SWORDS_DANCE
	db 52, PARASECT,   LEECH_LIFE, SPORE, SLASH, SWORDS_DANCE
	db 52, GOLDUCK,    CONFUSION, SCREECH, PSYCH_UP, FURY_SWIPES
	db -1 ; end
	...
	db 54, MAGNETON,   THUNDERBOLT, SUPERSONIC, SWIFT, SCREECH
	db 52, QUAGSIRE,   WATER_GUN, SLAM, AMNESIA, EARTHQUAKE
	db 52, QUAGSIRE,   WATER_GUN, SLAM, AMNESIA, EARTHQUAKE
	db 52, EXEGGCUTE,  LEECH_SEED, CONFUSION, SLEEP_POWDER, SOLARBEAM
	db -1 ; end
	...
	db 46, CHARMELEON, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 46, CHARMELEON, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 46, CHARMELEON, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 46, CHARMELEON, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 43, SKIPLOOM,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
	db 43, SKIPLOOM,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
	db 43, NINETALES,  EMBER, QUICK_ATTACK, CONFUSE_RAY, SAFEGUARD
	db -1 ; end
	...
	db 52, PIKACHU,    QUICK_ATTACK, DOUBLE_TEAM, THUNDERBOLT, THUNDER
	db 51, PIKACHU,    QUICK_ATTACK, DOUBLE_TEAM, THUNDERBOLT, THUNDER
	db 49, PIKACHU,    QUICK_ATTACK, DOUBLE_TEAM, THUNDERBOLT, THUNDER
	db 48, BLASTOISE,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 55, IVYSAUR,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 55, IVYSAUR,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 55, VENUSAUR,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 46, BUTTERFREE, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
	db 46, BUTTERFREE, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
	db 46, BUTTERFREE, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
	db 46, BELLOSSOM,  ABSORB, STUN_SPORE, ACID, SOLARBEAM
	db -1 ; end
...
BeautyGroup:
	...
	db 24, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 24, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	...
	db 33, HOPPIP,     SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
	db 33, HOPPIP,     SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
	db 33, SKIPLOOM,   SYNTHESIS, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
FisherGroup:
	...
	db 46, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 46, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 46, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 46, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
...
SwimmerFGroup:
	...
	db 36, PSYDUCK,    SCRATCH, TAIL_WHIP, DISABLE, CONFUSION
	db 36, PSYDUCK,    SCRATCH, TAIL_WHIP, DISABLE, CONFUSION
	db 37, GOLDEEN,    PECK, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
	...
	db 36, HORSEA,     BUBBLE, SMOKESCREEN, LEER, WATER_GUN
	db 36, HORSEA,     BUBBLE, SMOKESCREEN, LEER, WATER_GUN
	db 36, HORSEA,     DRAGON_RAGE, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
SuperNerdGroup:
	...
	db 41, SEADRA,     SMOKESCREEN, TWISTER, SURF, WATERFALL
	db 41, SEADRA,     SMOKESCREEN, TWISTER, SURF, WATERFALL
	db 41, SEADRA,     SMOKESCREEN, TWISTER, SURF, WATERFALL
	db 41, SEADRA,     SMOKESCREEN, TWISTER, SURF, WATERFALL
	db -1 ; end
	...
	db 40, SLOWPOKE,   CURSE, WATER_GUN, GROWL, STRENGTH
	db 40, SLOWPOKE,   CURSE, WATER_GUN, GROWL, STRENGTH
	db 40, SLOWPOKE,   CURSE, WATER_GUN, GROWL, STRENGTH
	db -1 ; end
...
HikerGroup:
	...
	db 49, DIGLETT,    MAGNITUDE, DIG, SAND_ATTACK, SLASH
	db 49, DIGLETT,    MAGNITUDE, DIG, SAND_ATTACK, SLASH
	db 49, DIGLETT,    MAGNITUDE, DIG, SAND_ATTACK, SLASH
...
BlackbeltGroup:
	...
	db 36, MACHOP,     LEER, FOCUS_ENERGY, KARATE_CHOP, SEISMIC_TOSS
	db 36, MACHOP,     LEER, FOCUS_ENERGY, KARATE_CHOP, SEISMIC_TOSS
	db 36, MACHOKE,    LEER, KARATE_CHOP, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
PsychicGroup:
	...
	db 29, DROWZEE,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db 29, DROWZEE,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db 29, DROWZEE,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db -1 ; end
	...
	db 34, SLOWPOKE,   TACKLE, GROWL, WATER_GUN, NO_MOVE
	db 34, SLOWPOKE,   TACKLE, GROWL, WATER_GUN, NO_MOVE
	db 35, SLOWPOKE,   CURSE, BODY_SLAM, WATER_GUN, CONFUSION
	db -1 ; end
	...
	db 29, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 30, KADABRA,    TELEPORT, KINESIS, CONFUSION, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (8)
	db "PHIL@", TRAINERTYPE_MOVES
	db 46, NATU,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
	db 46, NATU,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
	db 47, NATU,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
	db 47, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db -1 ; end
...
PicnickerGroup:
	...
	db 27, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db 27, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db 27, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
	...
	db 43, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db 43, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db 43, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end
...
PokefanMGroup:
	...
	db 77, BULBASAUR,  BERRY
	db 77, CHARMANDER, BERRY
	db 77, CHARMANDER, BERRY
	db 77, CHARMANDER, BERRY
	db 77, SQUIRTLE,   BERRY
	db -1 ; end
	...
	db 76, NIDOKING,   BERRY
	db 76, SLOWKING,   BERRY
	db 76, SLOWKING,   BERRY
	db 76, SEAKING,    BERRY
	db -1 ; end
